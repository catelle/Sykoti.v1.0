...
const DetailNewsModal: FC<DetailNewsModalProps> = ({ item, onClose }) => {
    ...
    return (
        ...
        className="fixed inset-0 rounded bg-black mt-6 bg-opacity-50 flex items-center justify-center">
        <div 
         style={{ borderRadius: '10px' }}
         className="bg-white dark:bg-gray-800 p-6 mt-6 rounded-lg max-w-md w-[300px] relative">
          <button
            onClick={onClose}
